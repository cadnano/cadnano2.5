...
class OrigamiPart(Part):
    """
    An OrigamiPart is a group of VirtualHelix items that are on the same lattice.
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(OrigamiPart, self).__init__(*args, **kwargs)
        # Data structure
