...
class PlasmidPart(Part):
    ...
    @classmethod
    def _count(cls):
        PlasmidPart.__count += 1
        return PlasmidPart.__count
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(PlasmidPart, self).__init__(*args, **kwargs)

        # Properties (PlasmidPart-specific)
        self._properties["name"] = "Plasmid%d" % self._count()
