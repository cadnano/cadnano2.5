...
class Ui_Preferences(object):
    def setupUi(self, Preferences):
        ...
        self.legacy_slice_view_label = QtWidgets.QLabel(Preferences)
        self.legacy_slice_view_label.setObjectName("legacy_slice_view_label")
        self.form_layout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.legacy_slice_view_label)
        self.legacy_slice_view_combo_box = QtWidgets.QComboBox(Preferences)
        ...
        self.grid_appearance_type_combo_box = QtWidgets.QComboBox(Preferences)
        ...
        self.form_layout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.grid_appearance_type_combo_box)
