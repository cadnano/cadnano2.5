...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.slice_grid_splitter = QtWidgets.QSplitter(self.main_splitter)
        self.slice_grid_splitter.setOrientation(QtCore.Qt.Vertical)
        self.slice_grid_splitter.setHandleWidth(0)
        self.slice_grid_splitter.setObjectName("slice_grid_splitter")
        self.slice_graphics_view = CustomQGraphicsView(self.slice_grid_splitter)
...
"")
        ...
        self.action_path_nick.setIcon(icon6)
        ...
        self.action_path_pencil.setIcon(icon8)
        ...
        self.action_new_dnapart_honeycomb.setIcon(icon4)
        ...
        self.action_new_dnapart_square.setIcon(icon5)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/slicetools/create-helix"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_create.setIcon(icon25)
        ...
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/parttools/filter-fwd"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_fwd.setIcon(icon26)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/parttools/filter-rev"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_rev.setIcon(icon27)
        ...
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/slicetools/select-helix"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_select.setIcon(icon28)
        ...
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/slicetools/snap-helix"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_snap.setIcon(icon29)
        ...
        self.action_global_create.setIcon(icon8)
        ...
        self.action_selectable_label = QtWidgets.QAction(MainWindow)
        self.action_selectable_label.setEnabled(False)
        self.action_selectable_label.setObjectName("action_selectable_label")
        self.action_toolbar_spacer = QtWidgets.QAction(MainWindow)
        self.action_toolbar_spacer.setEnabled(False)
        self.action_toolbar_spacer.setText("")
        self.action_toolbar_spacer.setVisible(True)
        self.action_toolbar_spacer.setObjectName("action_toolbar_spacer")
        ...
        self.selection_toolbar.addAction(self.action_toolbar_spacer)
        self.selection_toolbar.addAction(self.action_filter_helix)
        ...
        self.selection_toolbar.addAction(self.action_selectable_label)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_path_pencil.setText(_translate("MainWindow", "Create"))
        self.action_path_pencil.setToolTip(_translate("MainWindow", "(C)reate Tool"))
        self.action_path_pencil.setShortcut(_translate("MainWindow", "C"))
        ...
        self.action_global_create.setToolTip(_translate("MainWindow", "Pe(n)cil Tool"))
        self.action_global_create.setShortcut(_translate("MainWindow", "N"))
        ...
        self.action_selectable_label.setText(_translate("MainWindow", "Selectable:"))
        self.action_toolbar_spacer.setToolTip(_translate("MainWindow", "Selection Filters"))
