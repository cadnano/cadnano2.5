...
"")
        ...
        self.action_new_hcdnapart = QtWidgets.QAction(MainWindow)
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/parttools/hcpro"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_new_hcdnapart.setIcon(icon27)
        self.action_new_hcdnapart.setObjectName("action_new_hcdnapart")
        ...
        self.action_new_sqdnapart = QtWidgets.QAction(MainWindow)
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/parttools/sqpro"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_new_sqdnapart.setIcon(icon31)
        self.action_new_sqdnapart.setObjectName("action_new_sqdnapart")
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/parttools/filter-pre-axover"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.left_toolbar.addAction(self.action_new_hcdnapart)
        self.left_toolbar.addAction(self.action_new_sqdnapart)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_new_hcdnapart.setText(_translate("MainWindow", "HcPro"))
        self.action_new_hcdnapart.setIconText(_translate("MainWindow", "Hc"))
        self.action_new_hcdnapart.setToolTip(_translate("MainWindow", "Add HoneycombDNucleicAcidPart "))
        ...
        self.action_new_sqdnapart.setText(_translate("MainWindow", "Sq"))
        self.action_new_sqdnapart.setIconText(_translate("MainWindow", "Sq"))
        self.action_new_sqdnapart.setToolTip(_translate("MainWindow", "Add SquareDNucleicAcidPart "))
