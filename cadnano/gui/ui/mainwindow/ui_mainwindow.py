...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.slice_dock_widget.setMinimumSize(QtCore.QSize(600, 200))
        ...
        self.path_dock_widget.setMinimumSize(QtCore.QSize(400, 200))
...
"")
        ...
        self.sim_dock_widget.setMinimumSize(QtCore.QSize(600, 200))
        ...
        self.console_dock_widget.setMinimumSize(QtCore.QSize(400, 0))
        self.console_dock_widget.setMaximumSize(QtCore.QSize(400, 524287))
        self.console_dock_widget.setObjectName("console_dock_widget")
        self.console_dock_widget_contents = QtWidgets.QWidget()
        self.console_dock_widget_contents.setMaximumSize(QtCore.QSize(400, 16777215))
        self.console_dock_widget_contents.setStyleSheet("QWidget { background-color: rgb(96.5%, 96.5%, 96.5%); }")
        self.console_dock_widget_contents.setObjectName("console_dock_widget_contents")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.console_dock_widget_contents)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setSpacing(1)
        self.verticalLayout.setObjectName("verticalLayout")
        self.console_output_text = ConsoleOutput(self.console_dock_widget_contents)
        self.console_output_text.setStyleSheet("QPlainTextEdit { background-color: \"#fefefe\"; color: \"#0066cc\"; }")
        self.console_output_text.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.console_output_text.setFrameShadow(QtWidgets.QFrame.Plain)
        self.console_output_text.setObjectName("console_output_text")
        self.verticalLayout.addWidget(self.console_output_text)
        self.console_input_text = ConsoleInput(self.console_dock_widget_contents)
        self.console_input_text.setMaximumSize(QtCore.QSize(16777215, 24))
        self.console_input_text.setStyleSheet("QPlainTextEdit { background-color: \"#eeeeee\";}")
        self.console_input_text.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.console_input_text.setFrameShadow(QtWidgets.QFrame.Plain)
        self.console_input_text.setLineWidth(0)
        self.console_input_text.setMidLineWidth(0)
        self.console_input_text.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.console_input_text.setTabStopWidth(80)
        self.console_input_text.setBackgroundVisible(False)
        self.console_input_text.setObjectName("console_input_text")
        self.verticalLayout.addWidget(self.console_input_text)
        self.console_dock_widget.setWidget(self.console_dock_widget_contents)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.console_input_text.setPlaceholderText(_translate("MainWindow", "Enter command or type \"help\""))
        ...
        self.action_inspector.setToolTip(_translate("MainWindow", "Toggle Outliner"))
