...
"")
        ...
        self.action_create_helix = QtWidgets.QAction(MainWindow)
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(":/slicetools/create-helix"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_create_helix.setIcon(icon36)
        self.action_create_helix.setObjectName("action_create_helix")
        ...
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(":/parttools/filter-fwd"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_fwd.setIcon(icon37)
        ...
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(":/parttools/filter-rev"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_rev.setIcon(icon38)
        self.action_filter_rev.setObjectName("action_filter_rev")
        self.action_move_helix = QtWidgets.QAction(MainWindow)
        self.action_move_helix.setCheckable(True)
        icon39 = QtGui.QIcon()
        icon39.addPixmap(QtGui.QPixmap(":/slicetools/move-helix"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_move_helix.setIcon(icon39)
        self.action_move_helix.setObjectName("action_move_helix")
        self.action_snap_helix = QtWidgets.QAction(MainWindow)
        self.action_snap_helix.setCheckable(True)
        icon40 = QtGui.QIcon()
        icon40.addPixmap(QtGui.QPixmap(":/slicetools/snap-helix"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_snap_helix.setIcon(icon40)
        self.action_snap_helix.setObjectName("action_snap_helix")
        self.action_select_helix_angles = QtWidgets.QAction(MainWindow)
        self.action_select_helix_angles.setCheckable(True)
        icon41 = QtGui.QIcon()
        icon41.addPixmap(QtGui.QPixmap(":/slicetools/select-snap-angles"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_select_helix_angles.setIcon(icon41)
        self.action_select_helix_angles.setObjectName("action_select_helix_angles")
        ...
        self.left_toolbar.addAction(self.action_create_helix)
        self.left_toolbar.addAction(self.action_move_helix)
        self.left_toolbar.addAction(self.action_snap_helix)
        self.left_toolbar.addAction(self.action_select_helix_angles)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_create_helix.setText(_translate("MainWindow", "create"))
        self.action_create_helix.setToolTip(_translate("MainWindow", "Create Helix"))
        ...
        self.action_move_helix.setText(_translate("MainWindow", "move"))
        self.action_move_helix.setToolTip(_translate("MainWindow", "Move Helix"))
        self.action_snap_helix.setText(_translate("MainWindow", "snap"))
        self.action_snap_helix.setToolTip(_translate("MainWindow", "Snap Helix"))
        self.action_select_helix_angles.setText(_translate("MainWindow", "angles"))
        self.action_select_helix_angles.setToolTip(_translate("MainWindow", "Helix angle"))
