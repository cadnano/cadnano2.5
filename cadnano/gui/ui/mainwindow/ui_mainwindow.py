...
"")
        ...
        self.action_filter_fwd.setIcon(icon23)
        ...
        self.action_filter_rev.setIcon(icon24)
        ...
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/parttools/new-origami"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_new_part.setIcon(icon28)
        self.action_new_part.setObjectName("action_new_part")
        self.action_new_plasmidpart = QtWidgets.QAction(MainWindow)
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/parttools/new-dna"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_new_plasmidpart.setIcon(icon29)
        ...
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/parttools/sqpro"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_new_squarednapart.setIcon(icon30)
        ...
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/parttools/filter-pre-axover"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_pre_axover.setIcon(icon31)
        ...
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/parttools/filter-pre-pxover"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_pre_pxover.setIcon(icon32)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/parttools/filter-even"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_even.setIcon(icon33)
        ...
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/parttools/filter-odd"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_odd.setIcon(icon34)
        ...
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/slicetools/create-helix"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_create.setIcon(icon35)
        self.action_vhelix_create.setObjectName("action_vhelix_create")
        self.action_filter_fwd1 = QtWidgets.QAction(MainWindow)
        self.action_filter_fwd1.setCheckable(True)
        self.action_filter_fwd1.setChecked(True)
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(":/parttools/filter-fwd"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_fwd1.setIcon(icon36)
        self.action_filter_fwd1.setObjectName("action_filter_fwd1")
        self.action_filter_rev1 = QtWidgets.QAction(MainWindow)
        self.action_filter_rev1.setCheckable(True)
        self.action_filter_rev1.setChecked(True)
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(":/parttools/filter-rev"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_rev1.setIcon(icon37)
        self.action_filter_rev1.setObjectName("action_filter_rev1")
        self.action_vhelix_select = QtWidgets.QAction(MainWindow)
        self.action_vhelix_select.setCheckable(True)
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(":/slicetools/select-helix"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_select.setIcon(icon38)
        ...
        icon39 = QtGui.QIcon()
        icon39.addPixmap(QtGui.QPixmap(":/slicetools/snap-helix"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_snap.setIcon(icon39)
        ...
        icon40 = QtGui.QIcon()
        icon40.addPixmap(QtGui.QPixmap(":/slicetools/select-snap-angles"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_set_angles.setIcon(icon40)
        ...
        icon41 = QtGui.QIcon()
        icon41.addPixmap(QtGui.QPixmap(":/slicetools/grid-lines"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGridLines.setIcon(icon41)
        ...
        icon42 = QtGui.QIcon()
        icon42.addPixmap(QtGui.QPixmap(":/slicetools/grid-circles"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGridCircles.setIcon(icon42)
        ...
        icon43 = QtGui.QIcon()
        icon43.addPixmap(QtGui.QPixmap(":/slicetools/grid-points"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGridPoints.setIcon(icon43)
        ...
        self.right_toolbar.addAction(self.action_vhelix_snap)
        ...
        self.right_toolbar.addSeparator()
        self.right_toolbar.addAction(self.action_outliner)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_filter_fwd.setToolTip(_translate("MainWindow", "(C)Forward"))
        self.action_filter_fwd.setShortcut(_translate("MainWindow", "C"))
        self.action_filter_rev.setToolTip(_translate("MainWindow", "(T)Reverse"))
        self.action_filter_rev.setShortcut(_translate("MainWindow", "T"))
        ...
        self.action_filter_fwd1.setText(_translate("MainWindow", "filter-fwd"))
        self.action_filter_fwd1.setToolTip(_translate("MainWindow", "(F)wd"))
        self.action_filter_fwd1.setShortcut(_translate("MainWindow", "F"))
        self.action_filter_rev1.setText(_translate("MainWindow", "filter-rev"))
        self.action_filter_rev1.setToolTip(_translate("MainWindow", "(R)ev"))
        self.action_filter_rev1.setShortcut(_translate("MainWindow", "R"))
