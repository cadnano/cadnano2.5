...
#
# Created by: PyQt5 UI code generator 5.7.1.dev1611100918
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout = QtWidgets.QGridLayout(self.slice_dock_widget_contents)
        ...
        self.gridLayout.addWidget(self.slice_graphics_view, 0, 0, 1, 1)
        ...
        self.property_dock_widget = QtWidgets.QDockWidget(MainWindow)
        self.property_dock_widget.setMaximumSize(QtCore.QSize(300, 524287))
        self.property_dock_widget.setObjectName("property_dock_widget")
        self.property_dock_widget_contents = QtWidgets.QWidget()
        self.property_dock_widget_contents.setObjectName("property_dock_widget_contents")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.property_dock_widget_contents)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.outliner_property_splitter = QtWidgets.QSplitter(self.property_dock_widget_contents)
...
"")
        ...
        self.gridLayout_3.addWidget(self.outliner_property_splitter, 0, 0, 1, 1)
        self.property_dock_widget.setWidget(self.property_dock_widget_contents)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(2), self.property_dock_widget)
        ...
        self.gridLayout_2 = QtWidgets.QGridLayout(self.path_dock_widget_contents)
        ...
        self.gridLayout_2.addWidget(self.path_graphics_view, 0, 0, 1, 1)
        self.path_dock_widget.setWidget(self.path_dock_widget_contents)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(1), self.path_dock_widget)
        ...
        self.action_toggle_inspector_window = QtWidgets.QAction(MainWindow)
        self.action_toggle_inspector_window.setCheckable(True)
        self.action_toggle_inspector_window.setChecked(True)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/parttools/outliner"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_toggle_inspector_window.setIcon(icon20)
        self.action_toggle_inspector_window.setObjectName("action_toggle_inspector_window")
        self.action_new_plasmidpart = QtWidgets.QAction(MainWindow)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/parttools/new-dna"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_new_plasmidpart.setIcon(icon21)
        ...
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/parttools/sqpro"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_new_squarednapart.setIcon(icon22)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/parttools/filter-pre-axover"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_pre_axover.setIcon(icon23)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/parttools/filter-pre-pxover"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_pre_pxover.setIcon(icon24)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/parttools/filter-even"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_even.setIcon(icon25)
        ...
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/parttools/filter-odd"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_odd.setIcon(icon26)
        ...
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/slicetools/select-snap-angles"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_set_angles.setIcon(icon32)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/slicetools/grid-lines"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGridLines.setIcon(icon33)
        ...
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/slicetools/grid-circles"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGridCircles.setIcon(icon34)
        ...
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/slicetools/grid-points"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGridPoints.setIcon(icon35)
        ...
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(":/slicetools/move"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_move.setIcon(icon36)
        ...
        self.action_toggle_slice_window = QtWidgets.QAction(MainWindow)
        self.action_toggle_slice_window.setCheckable(True)
        self.action_toggle_slice_window.setChecked(True)
        self.action_toggle_slice_window.setObjectName("action_toggle_slice_window")
        self.action_toggle_path_window = QtWidgets.QAction(MainWindow)
        self.action_toggle_path_window.setCheckable(True)
        self.action_toggle_path_window.setChecked(True)
        self.action_toggle_path_window.setObjectName("action_toggle_path_window")
        self.action_toggle_solid_window = QtWidgets.QAction(MainWindow)
        self.action_toggle_solid_window.setCheckable(True)
        self.action_toggle_solid_window.setChecked(True)
        self.action_toggle_solid_window.setObjectName("action_toggle_solid_window")
        ...
        self.main_toolbar.addSeparator()
        self.selection_toolbar.addAction(self.action_toggle_inspector_window)
        self.selection_toolbar.addAction(self.action_toggle_solid_window)
        self.selection_toolbar.addAction(self.action_toggle_path_window)
        self.selection_toolbar.addAction(self.action_toggle_slice_window)
        ...
        self.menuWindow.addAction(self.action_toggle_slice_window)
        self.menuWindow.addAction(self.action_toggle_path_window)
        self.menuWindow.addAction(self.action_toggle_solid_window)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.property_dock_widget.setWindowTitle(_translate("MainWindow", "Inspector"))
        ...
        self.action_toggle_inspector_window.setText(_translate("MainWindow", "inspector"))
        self.action_toggle_inspector_window.setToolTip(_translate("MainWindow", "Toggle Outliner"))
        ...
        self.action_toggle_slice_window.setText(_translate("MainWindow", "Slice"))
        self.action_toggle_path_window.setText(_translate("MainWindow", "Path"))
        self.action_toggle_solid_window.setText(_translate("MainWindow", "3D"))
