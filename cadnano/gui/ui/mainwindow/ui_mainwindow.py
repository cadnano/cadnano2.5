...
#
# Created: Fri Jun 17 16:40:11 2016
...
"")
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/pathtools/modify"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_modify.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/parttools/filter-part"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_part.setIcon(icon15)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/parttools/filter-endpoint"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_endpoint.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/parttools/filter-xover"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_xover.setIcon(icon17)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/parttools/filter-strand"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_strand.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/parttools/filter-handle"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_handle.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/pathtools/mod"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_path_mods.setIcon(icon20)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/parttools/outliner"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_outliner.setIcon(icon21)
        self.action_outliner.setObjectName("action_outliner")
        self.action_new_part = QtWidgets.QAction(MainWindow)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/parttools/new-origami"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_new_part.setIcon(icon22)
        self.action_new_part.setObjectName("action_new_part")
        self.action_new_plasmidpart = QtWidgets.QAction(MainWindow)
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/parttools/new-dna"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_new_plasmidpart.setIcon(icon23)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/parttools/sqpro"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_new_squarednapart.setIcon(icon24)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/parttools/filter-even"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_even.setIcon(icon27)
        ...
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/parttools/filter-odd"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_odd.setIcon(icon28)
        ...
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/slicetools/create-helix"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_create.setIcon(icon29)
        ...
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/parttools/filter-fwd"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_fwd.setIcon(icon30)
        ...
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/parttools/filter-rev"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_filter_rev.setIcon(icon31)
        ...
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/slicetools/select-helix"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_select.setIcon(icon32)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/slicetools/snap-helix"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_snap.setIcon(icon33)
        ...
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/slicetools/select-snap-angles"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_set_angles.setIcon(icon34)
        ...
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/slicetools/grid-lines"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGridLines.setIcon(icon35)
        ...
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(":/slicetools/grid-circles"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGridCircles.setIcon(icon36)
        ...
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(":/slicetools/grid-points"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGridPoints.setIcon(icon37)
        ...
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(":/slicetools/move"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_vhelix_move.setIcon(icon38)
