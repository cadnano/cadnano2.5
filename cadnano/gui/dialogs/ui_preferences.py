...
class Ui_Preferences(object):
    def setupUi(self, Preferences):
        ...
        self.enabled_sliceview_combo_box = QtWidgets.QComboBox(Preferences)
        self.enabled_sliceview_combo_box.setObjectName("enabled_sliceview_combo_box")
        self.enabled_sliceview_combo_box.addItem("")
        self.enabled_sliceview_combo_box.addItem("")
        self.form_layout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.enabled_sliceview_combo_box)
    ...
    def retranslateUi(self, Preferences):
        ...
        self.enabled_sliceview_combo_box.setItemText(0, _translate("Preferences", "Legacy Slice View"))
        self.enabled_sliceview_combo_box.setItemText(1, _translate("Preferences", "Grid View"))
