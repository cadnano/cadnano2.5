...
class SolidVirtualHelixItem(AbstractVirtualHelixItem, QEntity):
    ...
    #             self._part_entity.updateXoverItems(self)
    #             dz = self._part_entity.convertToModelZ(x - old_x)
    ...
    #             dz = self._part_entity.convertToModelZ(dz)
    #             self._model_part.translateVirtualHelices([self.idNum()],
    #                                                      0, 0, dz, True,
    #                                                      use_undostack=True)
    # # end def
    ...
    #     """
    #     dx = self._part_entity.part().stepSize() * _BASE_WIDTH
    ...
    #         TYPE: Description
    #     """
    #     self._part_entity.updateStatusBar("")
    # # end def
    ...
    #     self._part_entity.updateStatusBar(loc)
