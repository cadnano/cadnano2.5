...
from .selectsolidtool import SelectTool
from .paintsolidtool import PaintTool


class SolidToolManager(AbstractToolManager):
    """
    Manages the interactions between Solid widgets / UI elements and the model.
    ...
    def __init__(self, window, viewroot):
        ...
        """
        super(SolidToolManager, self).__init__('solid', window, viewroot)
    ...
    #     """(SolidHelix, posInScene) or None, depending on where
